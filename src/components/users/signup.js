    ...
    handleSubmit = (event) => {
      ...
      render(){
        return (
            ...
            <button className="btn btn-lg dropdown-toggle btn-outline-secondary" data-toggle="dropdown">Register 
                <span className="caret"></span>
            </button>
            <ul className="dropdown-menu dropdown-lr animated flipInX">
